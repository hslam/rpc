...
import (
	...
	"github.com/hslam/rpc/benchmarks/client/transport/service"
...
func main() {
	...
	for i := 0; i < clients; i++ {
		trans := &rpc.Transport{
			...
			Options:             &rpc.Options{NewSocket: socket.NewTCPSocket, NewCodec: rpc.NewPBCodec, NewHeaderEncoder: rpc.NewPBEncoder},
		}
